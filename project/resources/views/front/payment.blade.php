...
<div class="page-content">
    <div class="container">
        <div class="row">
            <div class="col-lg-3 col-md-4 checkout-left mb_30">
            ...
            <div class="col-lg-4 col-md-4 checkout-right">
                <div class="inner" style="background-color: #FEFAE0; box-shadow: rgba(9, 30, 66, 0.25) 0px 1px 1px, rgba(9, 30, 66, 0.13) 0px 0px 1px 1px; border-radius: 10px">
                    ...
                    <div>
                        Town/City: {{ session()->get('billing_city') }}
                    </div>
                    <div>
                        Province: {{ session()->get('billing_state') }}
                    </div>
            ...
            <div class="col-lg-5 col-md-4 checkout-right">
                <div class="inner" style="background-color: #FEFAE0; box-shadow: rgba(9, 30, 66, 0.25) 0px 1px 1px, rgba(9, 30, 66, 0.13) 0px 0px 1px 1px; border-radius: 10px">
                                ...
                                for($i=0;$i<count($arr_cart_room_id);$i++)
                                {
                                    ...
                                    <tr>
                                        <td>
                                            {{ $room_data->name }}
                                            <br>
                                            ({{ DateTime::createFromFormat('d/m/Y', $arr_cart_checkin_date[$i])->format('F d, Y') }} - {{ DateTime::createFromFormat('d/m/Y', $arr_cart_checkout_date[$i])->format('F d, Y') }})
                                            <br>
