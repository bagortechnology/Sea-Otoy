        ...
        <div class="invoice-print">
                ...
                <div class="col-lg-12">
                    <div class="invoice-title">
                        <div class="d-flex align-items-center justify-content-between">
                            ...
                            <h2 class="text-center fs-2 text-uppercase" style="font-family: 'Arial', san-serif;">Reservation Invoice</h2>
                        ...
                        <h5 style="font-family: 'Arial', san-serif">Sea Otoy Beach House Resort</h5>
                        <span>Sitio Biga, Brgy. Hugom, San Juan, Batangas, Philippines</span><br>
                        <span>(+63) 981 751 4624</span>
                    ...
                    <div class="row">
                        <div class="col-md-6">
                            <address>
                                <b class="mt-2">Invoice to:</b><br>
                                {{ Auth::guard('customer')->user()->name }}<br>
                                {{ Auth::guard('customer')->user()->address }},<br>
                                {{ Auth::guard('customer')->user()->city }}, {{ Auth::guard('customer')->user()->state }}, {{ Auth::guard('customer')->user()->zip }}
                            </address>
                        </div>
            ...
            <div class="row mt-2">
                <div class="col-md-12">
                    ...
                    <p class="section-lead">The reservation detail information are given below:</p>
