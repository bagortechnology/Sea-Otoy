                        ...
                        <div class="row">
                            <div class="col-md-12">
                                ...
                                <div class="mb-4">
                                    ...
                                    <input type="text" class="form-control" name="video_id" value="{{ $video_data->video_id }}" style="border-color: #E38B29; border-radius: 5px">
                                </div>
                                <div class="mb-4">
                                    <label class="form-label">Caption</label>
                                    <input type="text" class="form-control" name="caption" value="{{ $video_data->caption }}" style="border-color: #E38B29; border-radius: 5px">
                                </div>
                                <div class="mb-4">
