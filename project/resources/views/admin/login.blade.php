                            ...
                            <div class="card-body card-body-auth">
                                ...
                                <form method="POST" action="{{ route('admin_login_submit') }}">
                                    ...
                                    <div class="form-group">
                                        <input type="text" class="form-control @error('email') is-invalid @enderror" name="email" placeholder="Email Address" value="{{ old('email') }}" autofocus style="border-color: #E38B29; border-radius: 5px">
                                        @error('email')
                                    ...
                                    <div class="form-group">
                                        <input type="password" class="form-control @error('password') is-invalid @enderror" name="password" placeholder="Password" style="border-color: #E38B29; border-radius: 5px">
                                        @error('password')
                                            <div class="text-danger">{{ $message }}</div>
                                        @enderror
                                    </div>
