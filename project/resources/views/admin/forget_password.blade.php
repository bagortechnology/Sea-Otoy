                            ...
                            <div class="card-body card-body-auth">
                                <form method="POST" action="{{ route('admin_forget_password_submit') }}">
                                    ...
                                    <div class="form-group">
                                        <input type="text" class="form-control @error('email') is-invalid @enderror" name="email" placeholder="Email Address" value="" autofocus style="border-color: #E38B29; border-radius: 5px">
                                        @error('email')
