                        ...
                        <div class="row">
                            <div class="col-md-12">
                                ...
                                <div class="mb-4">
                                    ...
                                    <input type="text" class="form-control" name="designation" value="{{ old('designation') }}" style="border-color: #E38B29; border-radius: 5px">
                                </div>
                                <div class="mb-4">
                                    <label class="form-label">Comment *</label>
                                    <textarea name="comment" class="form-control h_100" cols="30" rows="10" style="border-color: #E38B29; border-radius: 5px">{{ old('comment') }}</textarea>
                                </div>
                                <div class="mb-4">
